...
$ETCDCTL set /servicebroker/openshift/catalog/dfc126e9-181a-4d13-a367-f84edfe617ed/plan/521a4a06-175a-43e6-b1bc-d9c684f76a0d/schemas ' { "service_instance": { "create": { "parameters": { "$schema": "http://json-schema.org/draft-04/schema#", "type": "object", "properties": { "abc": { "description": "abc", "type": "string" }, "mno": { "description": "mno", "type": "integer", "minimum": 0, "maximum": 100 }, "xyz": { "description": "xyz", "type": "boolean" } } } }, "update": { "parameters": { "$schema": "http://json-schema.org/draft-04/schema#", "type": "object", "properties": { "abc": { "description": "abc", "type": "string" }, "mno": { "description": "mno", "type": "integer", "minimum": 0, "maximum": 100 }, "xyz": { "description": "xyz", "type": "boolean" } }, "additionalProperties": false } } }, "service_binding": { "create": { "parameters": { "$schema": "http://json-schema.org/draft-04/schema#", "type": "object", "properties": { "abc": { "description": "abc", "type": "string" }, "mno": { "description": "mno", "type": "integer", "minimum": 0, "maximum": 100 }, "xyz": { "description": "xyz", "type": "boolean" } } } } } }'
###创建套餐(volume_pvc)
